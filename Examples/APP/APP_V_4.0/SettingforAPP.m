...
totalDuration = 30;               % Duration in of the experiment (minutes)
numLoops=3; % Number of OID loops
epccNumLoops=numLoops;
Duration = totalDuration/numLoops;   % Duration of each loop (in our case the number is 1)
stepDuration = 5;                % Duration of each step (minutes). Note that the value passed to the function exceeds the response time, quantified in 80 mins for MPLac,r
obsstep=1;
